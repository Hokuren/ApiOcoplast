...
class QuantitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quantity" do
    assert_difference('Quantity.count') do
      post quantities_url, params: { quantity: { Lot_id: @quantity.Lot_id, Product_id: @quantity.Product_id, cost: @quantity.cost, weight: @quantity.weight } }, as: :json
    end
  ...
  test "should update quantity" do
    patch quantity_url(@quantity), params: { quantity: { Lot_id: @quantity.Lot_id, Product_id: @quantity.Product_id, cost: @quantity.cost, weight: @quantity.weight } }, as: :json
    assert_response 200
  end
